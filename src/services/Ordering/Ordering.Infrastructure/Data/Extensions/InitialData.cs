...
internal class InitialData
{
    ...
    public static IEnumerable<Order> OrdersWithItems
    {
        get
        {
            ...
            var address1 = Address.Of("san jose", "san jose", "san jose", "CR", "1953");
            var address2 = Address.Of("san jose", "san jose", "san jose", "CR", "1953");

            var payment1 = Payment.Of("1234512345123456", "jp", tomorrow, "123");
            var payment2 = Payment.Of("1234512345123456", "jp", tomorrow, "123");
